    ...
    <div id="create-task-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="create-task-form">
                ...
                <label for="task-notes">Descrição:</label>
                <textarea id="task-notes" placeholder="Digite a descrição"></textarea>

                <label for="task-due-date">Data:</label>
    ...
    <div id="edit-task-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="edit-task-form">
                ...
                <label for="edit-task-due-date">Data:</label>
                <input type="date" id="edit-task-due-date" />

                <label for="edit-task-due-time">Hora:</label>
