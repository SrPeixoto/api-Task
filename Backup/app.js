...
//         // Verifica se a tarefa foi concluída e a move para a lista de concluídas
//         updateTaskStatus(task);
//     });
// });

// function updateTaskStatus(task) {
//     // Obtém o ID da tarefa (caso seja necessário enviar para o backend)
//     const taskId = task.getAttribute('data-id');
    
//     // Atualiza o status da tarefa no banco de dados (essa função seria personalizada para seu backend)
//     fetch('update_task.php', {
//         method: 'POST',
//         headers: {
//             'Content-Type': 'application/json'
...
//     // Exibe a tarefa concluída na seção correspondente
//     moveTaskToCompleted(task);
// }

// // Função para mover a tarefa concluída para a seção de "Tarefas Concluídas"
...
//         // Adiciona a tarefa na lista de concluídas
...
//     // Mostrar a área de tarefas concluídas se houver tarefas
//     const completedTasks = document.querySelectorAll('.completed-task-list .task');
//     if (completedTasks.length > 0) {
//         document.querySelector('.completed-tasks-container').style.display = 'block';
//     } else {
//         document.querySelector('.completed-tasks-container').style.display = 'none';
//     }
// }

// // Marcar a tarefa como concluída no carregamento inicial se já estiver marcada no backend
...
document.getElementById('create-task-form').addEventListener('submit', (e) => {
    ...
    if (!taskTitle || !taskNotes || !taskDueDate || !taskDueTime) {
